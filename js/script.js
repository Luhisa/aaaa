...
modeloJson.map((item, index) => {
    ...
    modeloItem.querySelector('a').addEventListener('click', (e) => {
        ...
        modalQt = 1; //quantidade de produto ao abrir o modal
        modalKey = key;
        ...
        cs('.modeloInfo-size').forEach((size, sizeIndex) => {
            if (sizeIndex == 0){  /*COM ISSO, POR PADRÃO O "P" FICARA SELECIONADO (AZUL) AO CLICAR NO PRODUTO*/
